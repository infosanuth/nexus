...
const DoctorPatientHistory = () => {
  ...
  const handleExport = () => {
    const header = ['Ref', 'Patient', 'Phone Number', 'Age', 'Gender', 'Method', 'Last Visit']
  ...
  return (
    <div className='w-full max-w-6xl m-5'>
      ...
      <div className='bg-white border rounded text-sm max-h-[80vh] overflow-y-scroll'>
        <div className='max-sm:hidden grid grid-cols-[0.4fr_0.8fr_1.5fr_1.1fr_0.5fr_0.8fr_0.8fr_1.4fr] gap-1 py-3 px-6 border-b bg-gray-50 text-[11px] font-semibold text-gray-400 uppercase tracking-wider'>
          <p>#</p>
          <p>Ref</p>
          <p>Patient</p>
          <p>Phone Number</p>
        ...
        {paginatedPatients.map((item, index) => (
          <div className='flex flex-wrap justify-between max-sm:gap-5 max-sm:text-base sm:grid grid-cols-[0.4fr_0.8fr_1.5fr_1.1fr_0.5fr_0.8fr_0.8fr_1.4fr] gap-1 items-center text-gray-500 py-3 px-6 border-b hover:bg-gray-50' key={index}>
